        ...
        <header class="site-header" itemscope="" itemtype="http://schema.org/WPHeader">
            <div class="container">
                <div class="site-branding logo-with-site-identity" itemscope="" itemtype="http://schema.org/Organization">
                    <div class="site-logo"><a href="http://wpfolder/" class="custom-logo-link" rel="home">
                            <img width="80"
                                 height="80"
                                 src="http://wpfolder/wp-content/uploads/2019/06/лого-инст-12-e1561037572941.png"
                                 class="custom-logo"
                                 alt="МИНИСТЕРСТВО ПРИРОДНЫХ РЕСУРСОВ И ЭКОЛОГИИ РОССИЙСКОЙ ФЕДЕРАЦИИ<br>ФЕДЕРАЛЬНОЕ АГЕНТСТВО ПО НЕДРОПОЛЬЗОВАНИЮ"></a>
                    </div><!-- .site-logo -->
                    <div class="site-title-wrap"><h1 class="site-title" itemprop="name">
                            <a href="http://wpfolder/" rel="home" itemprop="url">МИНИСТЕРСТВО
                                ПРИРОДНЫХ РЕСУРСОВ И ЭКОЛОГИИ РОССИЙСКОЙ ФЕДЕРАЦИИ<br>ФЕДЕРАЛЬНОЕ АГЕНСТВО ПО
                                НЕДРОПОЛЬЗОВАНИЮ</a></h1>
                        <p class="site-description" itemprop="description">Центральный научно-исследовательский институт
