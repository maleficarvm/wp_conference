...
class event_contact_widgets extends WP_Widget {
	...
	function form( $instance ) {
		...
		<ul>
			...
			<li><a href="<?php if(!empty($address_link1)) echo esc_url_raw($address_link1); ?>" title="<?php echo esc_attr($address1); ?>" target="_blank"><i class="fa fa-map-marker"> </i> <?php echo esc_attr($address1); ?></a></li>
			<?php endif;
			if(!empty($phone_no1)): ?>
